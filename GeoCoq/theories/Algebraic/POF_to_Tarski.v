...
Check ltrBrDl.
rewrite -add_ratio ?ratioNr ?ratiovv // .  
rewrite andbAC. (*rewrite ltrNl. *) (* rewrite subr_lt0.*)
Admitted.
(*andbAC (*subr_lt0*) ltrNl ltrBrDl subr_lt0.
...
have [->|neq_ba] := eqVneq b a; [|move: neq_ba; rewrite -subr_eq0=> neq_ba].
  ...
  rewrite -!addrA subrr addr0 -opprB mulNmx eq_sym dotC opprB -mulNmx opprB.
